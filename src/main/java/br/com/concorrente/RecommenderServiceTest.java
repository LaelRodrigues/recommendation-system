...
// public class RecommenderServiceTest extends AbstractJavaSamplerClient
...
// String caminhoArquivo = "C:\\Users\\Laelr\\OneDrive\\Área de
// Trabalho\\programacao_concorrente\\concorrente\\src\\main\\resources\\teste2.csv";
...
// parts[i] = new DataManager(caminhoArquivo, (int) inicioParte, (int)
// fimParte);
...
// try {
// List<Map.Entry<String, Double>> recommendations =
// recommenderService.recommendBooks(userId, k);
...
// if (recommendation.getKey().equals(expectedBook) &&
// recommendation.getValue().equals(expectedRating)) {
